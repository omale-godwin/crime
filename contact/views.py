...
def contact(request):
    ...
    if request.method == 'POST':  
        ...
        messages.success(request, 'Your request has been submitted, a Kadpoy security will get back to you soon')
  ...
  if request.method == 'POST':
    ...
    if password == password2:
      ...
      if User.objects.filter(username=username).exists():
        messages.error(request, 'That REG Number Has Register')
